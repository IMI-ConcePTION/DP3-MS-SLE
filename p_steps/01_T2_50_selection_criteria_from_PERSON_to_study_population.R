...
D3_clean_spells[, c("spell_less_than_12_months_fup", "tot_x_days", "tot_spell_num") := NULL]

# Creation of all_cohort_entry_date_cleaned. Keep other spells even if they are less than 365 days long
D3_clean_spells[removed_row == 0, tot_spell_num := .N, by = person_id]
...
# Creation of all_cohort_exit_date_cleaned. Keep other spells even if they are less than 365 days long
D3_clean_spells[removed_row == 0, tot_spell_num := .N, by = person_id]
