...
for (outcome in OUTCOME_variables) {
  ...
  smart_save(period_prevalence, direxp, override_name = paste("D5_prevalence_period", outcome, sep = "_"), extension = extension, save_copy = "csv")
  smart_save(period_prevalence_masked, direxpmask, override_name = paste("D5_prevalence_period", outcome, "masked", sep = "_"), extension = extension, save_copy = "csv")
