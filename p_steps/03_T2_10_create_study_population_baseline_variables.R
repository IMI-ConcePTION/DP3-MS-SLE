...
D3_clean_spells <- D3_clean_spells[, .(person_id, entry_spell_category, exit_spell_category,
                                       is_the_study_spell)]
...
D3_study_population_SAP1[, cohort_entry_date := pmax(entry_spell_category, study_start, birth_date + years(15))]
D3_study_population_SAP1[, cohort_exit_date := pmin(exit_spell_category, birth_date + years(50) - 1)]
