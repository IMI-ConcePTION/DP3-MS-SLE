...
meanings_of_this_study[["HOSP"]] = c("hospitalisation_primary","hospitalisation_secondary","hospital_diagnosis","hopitalisation_diagnosis_unspecified","episode_primary_diagnosis","episode_secondary_diagnosis","diagnosis_procedure","hospitalisation_associated","hospitalisation_linked","HH","NH","hospitalisation_ICU_primary","hospitalisation_ICU_secondary","hospitalisation_ICU_unspecified","diag_hospitalisation_automatically_referred_to_PC","hospitalisation_not_overnight_primary","hospitalisation_not_overnight_secondary", "hospitalisation","hospitalisation_secundary")
meanings_of_this_study[["PC"]] = c("primary_care_event","primary_care_diagnosis","primary_care_events_BIFAP","primary_care_antecedents_BIFAP","primary_care_condicionants_BIFAP","primary_care_main_diagnosis","primary_care_secondary_diagnosis","primary_care_emergency_event")
meanings_of_this_study[["SPECIALIST"]] = c("specialist_diagnosis","outpatient_hospital_planned_primary","outpatient_hospital_planned_secondary",
"outpatient_contact_primary","outpatient_contact_secondary")
